...
public class MealFragment extends Fragment implements View.OnClickListener {
    ...
    final String GETMEAL_URL = Config.URL + "getcheck_meal.php";
    ...
    public static MealFragment createInstance(String patient_birth) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_success:
                insertToDatabase(patient_birth, "meal_check", getCheck_meal());
                getActivity().onBackPressed();
                break;
        }
    }

    public boolean[] getCheck_meal() {

        return new boolean[]{check_breakfast.isChecked(), check_lunch.isChecked(), check_dinner.isChecked()};
    }

    public void setCheck_meal(boolean[] check) {
            ...
            for (int i = 0; i < contents.length(); i++) {
                ...
                if (patient_birth.equals(birth)) {
                    ...
                    if (data_url.contains("meal")) {
                        setCheck_meal(new boolean[]{breakfast, lunch, dinner});
